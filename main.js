...
var main_state = {
    ...
    create: function() { 
        ...
        a_key.onDown.add(this.jumpUp, this); 
        d_key.onDown.add(this.jumpDown, this);
        a_key.onUp.add(this.stop, this); 
        d_key.onUp.add(this.stop, this); 
        ...
        this.bird = this.game.add.sprite(260, 245, 'bird');
        this.bird.scale.x *= -1;
